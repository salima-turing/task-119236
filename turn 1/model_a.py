...
def climate_model_step(local_temperature, dt, k):
    """
...
def main():
    ...
    # Initialize grid
    local_size = total_grid_points // size
    start = rank * local_size
    end = min((rank + 1) * local_size, total_grid_points)

    local_temperature = np.zeros(local_size) + 20.0
